			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat purple">
						...
						<div class="details">
							<div class="number number-completed-reports">
							</div>
							<div class="desc">
								Reports Completed
							</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat yellow">
						...
						<div class="details">
							<div class="number number-incomplete-reports">
							</div>
							<div class="desc">
								Reports Pending
							</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Incomplete Reports
							</div>
						</div>
									...
									<div class="table-responsive">
										<table class="table table-bordered table-hover table-striped">
											...
											<tr>
												...
												<th class="text-center" style="vertical-align: middle;">Company Name</th>
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Completed Reports
							</div>
						</div>
						<div class="portlet-body">
							<div class="row">
								<div class="col-md-12">
									<div class="table-responsive">
										<table class="table table-bordered table-hover table-striped">
											...
											<tbody id="complete_reports_table">
											</tbody>
										</table>
									</div>
								</div>
