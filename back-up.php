                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" role="form" method="post" action="appointment-directors.php">
                                ...
                                <div class="form-body hidden" id="check_1">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="4" name="used_in_text[]" class="form-control other-text" placeholder="Director's Profile Discussion"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="4" name="used_in_text[]" class="form-control other-text" placeholder="Discussion about Director's Time"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="4" name="used_in_text[]" class="form-control other-text" placeholder="Discuss about Director's Performance"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="4" name="used_in_text[]" class="form-control other-text" placeholder="[]'s remuneration is aligned with the remuneration paid to the other non-executive directors."></textarea>
                                        </div>
                                    </div>
                                    <p><strong>General Recommendation Guidelines</strong></p>
                                    <!--1-->
                                    <div class="form-group">
                                        <label class="col-md-10">Does the Company have a Nomination and Remuneration Committee? <b>value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="form-group hidden" id="does_the_company_have_a_nomination_and_remuneration_committee_block_1">
                                        <label class="col-md-10">Is the Nomination and Remuneration Committee Compliant? <b>value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <!--3-->
                                    <div class="form-group">
                                        <label class="col-md-10">Has the Company disclosed remuneration paid to the director? <b>value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <!--4-->
                                    <div class="form-group">
                                        <label class="col-md-10">Is the Company paying remuneration more than 25% of MD remuneration without any adequate Justification? (Not Applicable if director is getting remuneration due to other commitments)  <b>value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <!--5-->
                                    <div class="form-group">
                                        <label class="col-md-10">Is the remuneration paid to director more than 3 times the average NED remuneration (excluding the director being analysed) without adequate justification? (Not Applicable if director is getting remuneration due to other commitments) <b>value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <!--7-->
                                    <div class="form-group">
                                        <label class="col-md-10">Is the director liable to retire by rotation? <b>Value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <!--9-->
                                    <div class="form-group">
                                        <label class="col-md-10">Has the Company formed the board committees required under Companies Act, 2013? <b>Value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <!--10-->
                                    <div class="form-group">
                                        <label class="col-md-10">Did the Director attend all the Board Meetings held last year? <b>Value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <!--11-->
                                    <div class="form-group">
                                        <label class="col-md-10">Will the Board Composition fall below the applicable regulatory norms upon appointment of the director? <b>Value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <!--13-->
                                    <div class="form-group">
                                        <label class="col-md-10">Does the Director holds more than 10 public directorships or more than 20 total directorships?</label>
                                        <div class="col-md-2">
                                    ...
                                    <!--15-->
                                    <div class="form-group">
                                        <label class="col-md-10">Does the Director hold more than 5 committee chairmanships?</label>
                                        <div class="col-md-2">
                                    ...
                                    <!--18-->
                                    <div class="form-group">
                                        <label class="col-md-10">Has the Director missed all the Board meetings in the financial year?</label>
                                        <div class="col-md-2">
                                ...
                                <div class="form-body hidden" id="check_2">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="4" name="used_in_text[]" class="form-control other-text" placeholder="Director's Independence Discussion"></textarea>
                                        </div>
                                    </div>
                                    <p><strong>Director's Time Commitment</strong></p>
                                    <div class="form-group">
                                    ...
                                    <!--12-->
                                    <div class="form-group">
                                        <label class="col-md-10">Is the tenure of director more than 10 years (in Company or group company)?</label>
                                        <div class="col-md-2">
                                    ...
                                    <!--16-->
                                    <div class="form-group">
                                        <label class="col-md-10">Does the Director have a pecuniary relationship with the Company?</label>
                                        <div class="col-md-2">
                                    ...
                                    <!--25-->
                                    <div class="form-group">
                                        <label class="col-md-10">Does the Director serve on boards of more than 7 listed companies (3 in case the person is serving as a whole time director in a listed company) and total directorships in public companies is more than 10?</label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="board-chairman-arid-questions hidden">
                                        ...
                                        <!--27-->
                                        <div class="form-group">
                                            <label class="col-md-10">Is the attendance of the Director at board meetings held in the last three years less than 75%?</label>
                                            <div class="col-md-2">
                                    ...
                                    <!--60-->
                                    <div class="form-group">
                                        <label class="col-md-10">Is the attendance at board meetings held last year was less than 50%?</label>
                                        <div class="col-md-2">
                                    ...
                                    <!--61-->
                                    <div class="form-group">
                                        <label class="col-md-10">Was the Attendance at Audit Committee meetings held last year was less than 50%? </label>
                                        <div class="col-md-2">
                                    ...
                                    <!--62-->
                                    <div class="form-group">
                                        <label class="col-md-10">Was the attendance at board meetings held in the last three years was less than 75%? (NA if attendance increased in recent years)</label>
                                        <div class="col-md-2">
                                    ...
                                    <!--63-->
                                    <div class="form-group">
                                        <label class="col-md-10">Was the attendance at Audit Committee meetings held in last three years was less than 75%?</label>
                                        <div class="col-md-2">
                                    ...
                                    <!--64-->
                                    <div class="form-group">
                                        <label class="col-md-10">Was the attendance at Nomination & Remuneration Committee meetings held in last 3 years less than 75%?</label>
                                        <div class="col-md-2">
                                    ...
                                    <!--65-->
                                    <div class="form-group">
                                        <label class="col-md-10">Is the Independent Director(s) liable to retire by rotation?</label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="4" name="recommendation_text[]" class="form-control recommendation-text" id="recommendation_text_arid" placeholder="Enter recommendation"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-body hidden" id="check_3">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-hover table-stripped">
                                                ...
                                                <tr>
                                                    <td colspan="2"><input class="form-control" name="past_rem_dir_name"/></td>
                                                    <td><input class="form-control" name="fixed_pay_year1"/></td>
                                                    <td><input class="form-control" name="total_pay_year1"/></td>
                                                    <td><input class="form-control" name="fixed_pay_year2"/></td>
                                                    <td><input class="form-control" name="total_pay_year2"/></td>
                                                    <td><input class="form-control" name="fixed_pay_year3"/></td>
                                                    <td><input class="form-control" name="total_pay_year3"/></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-hover table-stripped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" name="ex_rem_col_1[]"/> </td>
                                                    <td><input class="form-control" name="ex_rem_col_2[]"/> </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tr>
                                                    <td>
                                                        <select class="form-control" name="ex_rem_years[]">
                                                            <option>Select Year</option>
                                                            <?php
                                                            for($year=2010;$year<=2020;$year++) {
                                                                echo "<option value='$year'>$year</option>";
                                                ...
                                                <tr>
                                                    <td><input class="form-control" name="ex_rem_years[]"></td>
                                                    <td><input class="form-control" name="ed_remuneration[]"></td>
                                                    <td><input class="form-control" name="indexed_tsr[]"></td>
                                                    <td><input class="form-control" name="net_profit[]"></td>
                                                </tr>
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tr class="tr-td-center">
                                                    ...
                                                    <td>
                                                        Proposed Salary :
                                                        <input class="form-control" name="rem_package[]"/>
                                                    </td>
                                                    <td rowspan="2"><input class="form-control" name="rem_package[]"></td>
                                                </tr>
                                                <tr class="tr-td-center">
                                                    <td>
                                                        Annual increment:
                                                ...
                                                <tr class="tr-td-center">
                                                    ...
                                                    <td>
                                                        ...
                                                        <select class="form-control" name="rem_package[]">
                                                            <option value="">Select</option>
                                                            <option value="yes">Yes</option>
                                                            <option value="no">No</option>
                                                        </select>
                                    ...
                                    <!--36-->
                                    <div class="form-group">
                                        <label class="col-md-10">Is the remuneration paid to the executive director excessive? (Not applicable if the Director is appointed elsewhere also) <b>Value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <!--37-->
                                    <div class="form-group">
                                        <label class="col-md-10">Does the resolution provide the Board discretion to change remuneration without taking further shareholder approval and the total remuneration is without any limit? <b>Value</b></label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="4" name="recommendation_text[]" id="recommendation_text_ared" class="form-control recommendation-text" placeholder="Enter recommendation"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-body hidden" id="check_4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="hidden" name="used_in[]" value="Resolution">
                                            <textarea rows="4" class="form-control" name="used_in_text[]" placeholder="Enter text of the Resolution"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="4" class="form-control" name="used_in_text[]" placeholder="Enter text of the company's justification"></textarea>
                                        </div>
                                    </div>
