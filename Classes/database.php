...
class Database {
	...
	function deleteDirector($company_id,$dir_din_no,$financial_year) {
		$status=array();
		$dbobject = new PDO(DB_TYPE.":host=".DB_HOST.";dbname=".DB_NAME, DB_USER, DB_PASSWORD);
		$stmt1=$dbobject->prepare(" delete from `audit_committee_attendance` where `dir_din_no`=:din_no and `company_id`=:company_id and `att_year`=:financial_year");
		$stmt1->bindParam(':din_no', $dir_din_no);
		$stmt1->bindParam(':company_id', $company_id);
		$stmt1->bindParam(':financial_year', $financial_year);
		$stmt1->execute();
		$stmt2=$dbobject->prepare(" delete from `csr_committee_meetings_attendance` where `dir_din_no`=:din_no and `company_id`=:company_id and `att_year`=:financial_year");
		$stmt2->bindParam(':din_no', $dir_din_no);
		$stmt2->bindParam(':company_id', $company_id);
		$stmt2->bindParam(':financial_year', $financial_year);
		$stmt2->execute();
		$stmt3=$dbobject->prepare(" delete from `director_agm_attendance` where `dir_din_no`=:din_no and `company_id`=:company_id and `att_year`=:financial_year");
		$stmt3->bindParam(':din_no', $dir_din_no);
		$stmt3->bindParam(':company_id', $company_id);
		$stmt3->bindParam(':financial_year', $financial_year);
		$stmt3->execute();
		$stmt4=$dbobject->prepare(" delete from `director_board_attendance` where `dir_din_no`=:din_no and `company_id`=:company_id and `att_year`=:financial_year");
		$stmt4->bindParam(':din_no', $dir_din_no);
		$stmt4->bindParam(':company_id', $company_id);
		$stmt4->bindParam(':financial_year', $financial_year);
		$stmt4->execute();
		$stmt5=$dbobject->prepare(" delete from `director_info` where `dir_din_no`=:din_no and `company_id`=:company_id and `financial_year`=:financial_year");
		$stmt5->bindParam(':din_no', $dir_din_no);
		$stmt5->bindParam(':company_id', $company_id);
		$stmt5->bindParam(':financial_year', $financial_year);
		$stmt5->execute();
		$stmt6=$dbobject->prepare(" delete from `director_remuneration` where `dir_din_no`=:din_no and `company_id`=:company_id and `rem_year`=:financial_year");
		$stmt6->bindParam(':din_no', $dir_din_no);
		$stmt6->bindParam(':company_id', $company_id);
		$stmt6->bindParam(':financial_year', $financial_year);
		$stmt6->execute();
		$stmt7=$dbobject->prepare(" delete from `investors_grievance_attendance` where `dir_din_no`=:din_no and `company_id`=:company_id and `att_year`=:financial_year");
		$stmt7->bindParam(':din_no', $dir_din_no);
		$stmt7->bindParam(':company_id', $company_id);
		$stmt7->bindParam(':financial_year', $financial_year);
		$stmt7->execute();
		$stmt8=$dbobject->prepare(" delete from `input_sheet_comments` where `din_no`=:din_no and `company_id`=:company_id and `financial_year`=:financial_year");
		$stmt8->bindParam(':din_no', $dir_din_no);
		$stmt8->bindParam(':company_id', $company_id);
		$stmt8->bindParam(':financial_year', $financial_year);
		$stmt8->execute();
		$stmt9=$dbobject->prepare(" delete from `nomination_committee_attendance` where `dir_din_no`=:din_no and `company_id`=:company_id and `att_year`=:financial_year");
		$stmt9->bindParam(':din_no', $dir_din_no);
		$stmt9->bindParam(':company_id', $company_id);
		$stmt9->bindParam(':financial_year', $financial_year);
		$stmt9->execute();
		$stmt10=$dbobject->prepare(" delete from `nomination_remuneration_committee_attendance` where `dir_din_no`=:din_no and `company_id`=:company_id and `att_year`=:financial_year");
		$stmt10->bindParam(':din_no', $dir_din_no);
		$stmt10->bindParam(':company_id',$company_id);
		$stmt10->bindParam(':financial_year',$financial_year);
		$stmt10->execute();
		$stmt11=$dbobject->prepare(" delete from `remuneration_committee_attendance` where `dir_din_no`=:din_no and `company_id`=:company_id and `att_year`=:financial_year");
		$stmt11->bindParam(':din_no', $dir_din_no);
		$stmt11->bindParam(':company_id',$company_id);
		$stmt11->bindParam(':financial_year',$financial_year);
		$stmt11->execute();
		$stmt12=$dbobject->prepare(" delete from `risk_management_committee_meetings_attendance` where `dir_din_no`=:din_no and `company_id`=:company_id and `att_year`=:financial_year");
		$stmt12->bindParam(':din_no', $dir_din_no);
		$stmt12->bindParam(':company_id',$company_id);
		$stmt12->bindParam(':financial_year',$financial_year);
		$stmt12->execute();
