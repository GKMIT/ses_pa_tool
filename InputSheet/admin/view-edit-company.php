...
$flag= false;
$msg ="";
if(isset($_POST['btn_save_company_info'])) {
    $db = new Database();
    ...
    if($_POST['peer_1_company_name']!="") {
        $info['peer1']=$_POST['peer_1_company_id'];
    }
    else {
        $info['peer1']=0;
    }
    if($_POST['peer_2_company_name']!="") {
        $info['peer2']=$_POST['peer_2_company_id'];
    }
    else {
        $info['peer2']=0;
    }
    $response = $db->editCompany($info);
    $flag = true;
                ...
                <div class="col-md-12">
                    <div class="portlet box">
                        <div class="portlet-body form animation">
                            ...
                            <form class="form-horizontal" method="post" action="view-edit-company.php">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-condensed" id="company_details">
                                            </table>
                                        </div>
                                    </div>
                                    <div class="form-group company-details-essentials hidden">
                                        <div class="col-md-12">
                                            <button name="btn_save_company_info" id="btn_save_company_details" type="submit" class="btn green"><i class="fa fa-edit"></i>&nbsp;&nbsp;Save Company Details</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        <?php
         if($flag) {
        ?>
            object.initializeEditCompany(messages,true);
        <?php
         }
         else {
         ?>
            object.initializeEditCompany(messages,false);
        <?php
         }
        ?>
    });
