...
$flag= false;
$msg ="";
if(isset($_POST['btn_edit_auditor_info'])) {
    $db = new Database();
    $info['company_auditors_info_id'] = $_POST['company_auditors_info_id'];
                ...
                <div class="col-md-12">
                    <div class="portlet box">
                        <div class="portlet-body form">
                            <form class="form-horizontal" method="post" action="edit-auditor-info.php">
                                <input type="hidden" name="company_auditors_info_id" id="company_auditors_info_id" />
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control flushable" name="no_of_auditors" id="no_of_auditors">
                                    ...
                                    <div class="auditors-info-container">
                                        <div class="auditor-info-template">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_name_1" name="auditor_name[]" placeholder="First auditor's name"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_name_2 hidden" name="auditor_name[]" placeholder="Second auditor's name"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_name_3 hidden" name="auditor_name[]" placeholder="Third auditor's name"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_parent_company_2 hidden" name="auditor_parent_company[]" placeholder="Second auditor's parent company"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_parent_company_3 hidden" name="auditor_parent_company[]" placeholder="Third auditor's parent company"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Auditor's Tenure</label>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_tenure_1" name="auditor_tenure[]" placeholder="First auditor's tenure in years"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_tenure_2 hidden" name="auditor_tenure[]" placeholder="Second auditor's tenure in years"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_tenure_3 hidden" name="auditor_tenure[]" placeholder="Third auditor's tenure in years"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Audit Partner Name</label>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_partner_name_1" name="auditor_partner_name[]" placeholder="First audit partner name"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_partner_name_2 hidden" name="auditor_partner_name[]" placeholder="Second audit partner name"/>
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_partner_tenure_1" name="auditor_partner_tenure[]" placeholder="First audit partner tenure in years"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_partner_tenure_2 hidden" name="auditor_partner_tenure[]" placeholder="Second audit partner tenure in years"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control flushable auditor_partner_tenure_3 hidden" name="auditor_partner_tenure[]" placeholder="Third audit partner name in years"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control flushable" name="net_profit" id="net_profit"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Audit Fee (In <i class="fa fa-rupee"></i> Crore)</label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control flushable" name="audit_fee" id="audit_fee"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Audit Related Fee (In <i class="fa fa-rupee"></i> Crore)</label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control flushable" name="audit_related_fee" id="audit_related_fee"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Non-Audit Fee (In <i class="fa fa-rupee"></i> Crore)</label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control flushable" name="non_audit_fee" id="non_audit_fee"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Total Auditors Fee (In <i class="fa fa-rupee"></i> Crore)</label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control flushable" readonly name="total_auditors_fee" id="total_auditors_fee"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-actions fluid">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button name="btn_edit_auditor_info" type="submit" class="btn green"><i class="fa fa-floppy-o"></i>&nbsp;&nbsp;Update Auditor Details</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        <?php
         if($flag) {
        ?>
            object.initializeEditAuditorsInfo(messages,true);
        <?php
         }
         else {
         ?>
            object.initializeEditAuditorsInfo(messages,false);
        <?php
         }
        ?>
    });
