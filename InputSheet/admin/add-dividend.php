...
if(isset($_POST['btn_dividend_info'])) {
    ...
    $response = $db->addDividendInfo($info);
    $flag = true;
                ...
                <div class="col-md-12">
                    <div class="portlet box">
                        <div class="portlet-body form">
                            <form class="form-horizontal" method="post" action="add-dividend.php">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input class="form-control" name="market_price_start" id="market_price_start" placeholder="Market price at year start"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Market Price at year end (<i class="fa fa-rupee"></i>) </label>
                                        <div class="col-md-4">
                                            <input class="form-control" name="market_price_end" id="market_price_end" placeholder="Market Price at year end"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Dividend (<i class="fa fa-rupee"></i>) </label>
                                        <div class="col-md-4">
                                            <input class="form-control" name="dividend" placeholder="Dividend Value"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">EPS(<i class="fa fa-rupee"></i>) </label>
                                        <div class="col-md-4">
                                            <input class="form-control" name="eps" placeholder="EPS"/>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        <?php
         if($flag) {
        ?>
            object.initializeDivindendInfoJs(messages,true);
        <?php
         }
         else {
         ?>
            object.initializeDivindendInfoJs(messages,false);
        <?php
         }
        ?>
    });
