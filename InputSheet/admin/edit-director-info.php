...
$flag= false;
$msg ="";
if(isset($_POST['btn_edit_director_info'])) {
    $db = new Database();
    ...
    $response = $db->editDirectorInfo($info);
    $flag = true;
                ...
                <div class="col-md-12">
                    <div class="portlet box">
                        <div class="portlet-body form">
                            <form class="form-horizontal" method="post" action="edit-director-info.php  ">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Current Tenure</label>
                                        <div class="col-md-4">
                                            <input class="form-control flushable" name="current_tenure" id="current_tenure" placeholder="In years"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Total Association</label>
                                        <div class="col-md-4">
                                            <input class="form-control flushable" name="total_association" id="total_association" placeholder="In years"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Company Classification</label>
                                        <div class="col-md-4">
                                            <select class="form-control flushable" name="company_classification" id="company_classification">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">SES Classification</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Additional Classification</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Audit Committee Classification</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Investors' Grievance/Stakeholders Relationship Committee Classification</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Is the Nomination and Remuneration Committee separate Committees?</label>
                                        <div class="col-md-4">
                                            <input type="hidden" name="is_nom_rem_separate_hidden" id="is_nom_rem_separate_hidden" />
                                            <select class="form-control flushable" name="is_nom_rem_separate" id="is_nom_rem_separate">
                                                <option value="">Select Option</option>
                                    ...
                                    <div class="form-group hidden nom_rem_same">
                                        <label class="col-md-4 control-label">Nomination and Remuneration Committee Classification</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group hidden nom_rem_not_same">
                                        <label class="col-md-4 control-label">Remuneration Committee Classification</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group hidden nom_rem_not_same">
                                        <label class="col-md-4 control-label">Nomination Committee Classification</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">CSR Committee Classification</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Risk Management Committee Classification</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Retiring/Non Retiring</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Ratio to MRE</label>
                                        <div class="col-md-4">
                                ...
                                <div class="form-actions fluid">
                                    <div class="col-md-offset-4 col-md-4">
                                        <button name="btn_edit_director_info" type="submit" class="btn green"><i class="fa fa-floppy-o"></i>&nbsp;&nbsp;Update Director Info</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        <?php
         if($flag) {
        ?>
        object.initializeDirectorInfoEdit(messages,true);
        <?php
         }
         else {
         ?>
        object.initializeDirectorInfoEdit(messages,false);
        <?php
         }
        ?>
    });
