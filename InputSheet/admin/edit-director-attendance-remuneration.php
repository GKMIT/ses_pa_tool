...
$flag= false;
$msg ="";
if(isset($_POST['btn_edit_director_attendance_and_pay_details'])) {
    $db = new Database();
    ...
    if(isset($_POST['rem_nom_same_committee'])) {
        if($_POST['rem_nom_same_committee']=='yes') {
    ...
    $response = $db->directorBoardPayAttendanceEdit($info);
    $flag = true;
                ...
                <div class="col-md-12">
                    <div class="portlet box">
                        <div class="portlet-body form">
                            <form class="form-horizontal" method="post" action="edit-director-attendance-remuneration.php">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="att_year" id="att_year" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select class="form-control flushable" name="agm_attended" id="agm_attended">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input class="form-control flushable" name="board_meetings_attended" id="board_meetings_attended" placeholder="Enter no. of meetings attended or ND if not disclosed"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Board Meetings Held</label>
                                        <div class="col-md-4">
                                            <input class="form-control flushable" name="board_meetings_held" id="board_meetings_held" placeholder="Enter no. of meetings held or ND if not disclosed"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Variable Pay in <i class="fa fa-rupee"></i> Crore</label>
                                        <div class="col-md-4">
                                            <input class="form-control flushable" name="variable_pay" id="variable_pay" placeholder="Enter variable pay in Rs. Crore"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Fixed Pay in <i class="fa fa-rupee"></i> Crore</label>
                                        <div class="col-md-4">
                                            <input class="form-control flushable" name="fixed_pay" id="fixed_pay" placeholder="Enter fixed pay in Rs. Crore"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-actions fluid">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button name="btn_edit_director_attendance_and_pay_details" type="submit" class="btn green"><i class="fa fa-floppy-o"></i>&nbsp;&nbsp;Save Details</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        <?php
         if($flag) {
        ?>
            object.initializeEditDirectorAttendanceRemuneration(messages,true);
        <?php
         }
         else {
         ?>
            object.initializeEditDirectorAttendanceRemuneration(messages,false);
        <?php
         }
        ?>
    });
