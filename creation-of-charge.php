                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-10">Has the Company disclosed details of assets being mortgaged or details of borrowings being secured? (For standalone/ specific resolutions for creation of charge)</label>
                                        <div class="col-md-2">
                                            <select class='form-control'>
                                                <option value="">Select</option>
                                                <option value="Yes">Yes</option>
